...
graficocon<-sjPlot::plot_scatter(data_numerica,percepcion_politico_econ,confianza_inst)
ggsave(graficocon,file="Output/graphics/graficocon.png")
...
graph3<-ggarrange(graph1, graph2, nrow = 1) # Unir graficos

ggsave(graph2,file="Output/graphics/graph2.png")
ggsave(graph3,file="Output/graphics/graph3.png")
```
...
knitreg(list(reg1),
        ...
        caption.above = TRUE)
ggsave("reg1,file=Output/graphics/reg1.png")
```
